...
alter table user_roles add constraint FK55itppkw3i07do3h7qoclqd4k foreign key (user_id) references user (id);
    ...
    alter table bug_ticket 
       add constraint FK9psgsr1uxbx24t3dyat1n9ffr 
       foreign key (assigned_to) 
       references user (id);

    alter table bug_ticket 
       add constraint FKnyrx5p68a5sogdtb6npyshyes 
       foreign key (created_by) 
       references user (id);

    alter table bug_ticket 
       add constraint FKfu2u2lolasf0s83scpeciv8q8 
       foreign key (project_id) 
       references project (id);

    alter table comment 
       add constraint FKeqiv1owal53xrdbid976rhhk1 
       foreign key (ticket_id) 
       references bug_ticket (id);
    ...
    alter table file 
       add constraint FK9xpbf8klk9il032sq5xupl1f 
       foreign key (project_id) 
       references project (id);

    alter table project 
       add constraint FK76fngi71pfr8phbobe5pq0swd 
       foreign key (company_id) 
       references company (id);

    alter table project_users 
       add constraint FKswc4g4h18lbxsl9obvo97lnbl 
       foreign key (user_id) 
       references user (id);

    alter table project_users 
       add constraint FK9at0ei37rls7vd2m6sh92668h 
       foreign key (project_id) 
       references project (id);
    ...
    alter table comment 
       add constraint FK3sv41rtg7i6je9xvyog9xo9dp 
       foreign key (created_by) 
       references user (id);
...
alter table user_roles add constraint FK55itppkw3i07do3h7qoclqd4k foreign key (user_id) references user (id);
    ...
    create table role (
        id bigint not null auto_increment,
        role_name enum ('ADMIN','DEVELOPER','GUEST') not null,
        primary key (id)
    ) engine=InnoDB;
